(function (LIB) {
    var CannonJSPlugin = /** @class */ (function () {
        function CannonJSPlugin(_useDeltaForWorldStep, iterations) {
            ...
            this._tmpDeltaPosition = LIB.Vector3.Zero();
            this._tmpUnityRotation = new LIB.Quaternion();
            if (!this.isSupported()) {
                LIB.Tools.Error("CannonJS is not available. Please make sure you included the js file.");
                return;
            }
                ...
                var processMesh = function (localPosition, mesh) {
                    ...
                    if (childImpostor) {
                        ...
                        if (parent !== mainImpostor) {
                            ...
                            var localRotation = mesh.rotationQuaternion.multiply(LIB.Quaternion.Inverse(currentRotation));
        ...
        CannonJSPlugin.prototype.generateJoint = function (impostorJoint) {
            ...
            switch (impostorJoint.joint.type) {
                ...
                case LIB.PhysicsJoint.Hinge2Joint:
                ...
                case LIB.PhysicsJoint.SpringJoint:
                    ...
                    break;
                case LIB.PhysicsJoint.LockJoint:
                    constraint = new this.BJSCANNON.LockConstraint(mainBody, connectedBody, constraintData);
                    break;
                case LIB.PhysicsJoint.PointToPointJoint:
            ...
            if (impostorJoint.joint.type !== LIB.PhysicsJoint.SpringJoint) {
        ...
        CannonJSPlugin.prototype._checkWithEpsilon = function (value) {
            return value < LIB.PhysicsEngine.Epsilon ? LIB.PhysicsEngine.Epsilon : value;
        };
        CannonJSPlugin.prototype._createShape = function (impostor) {
            ...
            switch (impostor.type) {
                ...
                case LIB.PhysicsImpostor.PlaneImpostor:
                    LIB.Tools.Warn("Attention, PlaneImposter might not behave as you expect. Consider using BoxImposter instead");
                    returnValue = new this.BJSCANNON.Plane();
                    break;
                case LIB.PhysicsImpostor.MeshImpostor:
                    // should transform the vertex data to world coordinates!!
                    var rawVerts = object.getVerticesData ? object.getVerticesData(LIB.VertexBuffer.PositionKind) : [];
                    ...
                    for (index = 0; index < rawVerts.length; index += 3) {
                        LIB.Vector3.TransformCoordinates(LIB.Vector3.FromArray(rawVerts, index), transform).toArray(temp, index);
                    }
                    LIB.Tools.Warn("MeshImpostor only collides against spheres.");
                    ...
                    break;
                case LIB.PhysicsImpostor.HeightmapImpostor:
        ...
        CannonJSPlugin.prototype._createHeightmap = function (object, pointDepth) {
            var pos = (object.getVerticesData(LIB.VertexBuffer.PositionKind));
            var transform = object.computeWorldMatrix(true);
            // convert rawVerts to object space
            var temp = new Array();
            var index;
            for (index = 0; index < pos.length; index += 3) {
                LIB.Vector3.TransformCoordinates(LIB.Vector3.FromArray(pos, index), transform).toArray(temp, index);
            }
            pos = temp;
        ...
        CannonJSPlugin.prototype._updatePhysicsBodyTransformation = function (impostor) {
            ...
            if (impostor.type === LIB.PhysicsImpostor.PlaneImpostor || impostor.type === LIB.PhysicsImpostor.HeightmapImpostor || impostor.type === LIB.PhysicsImpostor.CylinderImpostor) {
            ...
            if (impostor.type === LIB.PhysicsImpostor.HeightmapImpostor) {
                var mesh = object;
