(function (LIB) {
    var VertexData = /** @class */ (function () {
        ...
        VertexData.prototype.set = function (data, kind) {
            switch (kind) {
                case LIB.VertexBuffer.PositionKind:
                    this.positions = data;
                    break;
                case LIB.VertexBuffer.NormalKind:
                    this.normals = data;
                    break;
                case LIB.VertexBuffer.TangentKind:
                    this.tangents = data;
                    break;
                case LIB.VertexBuffer.UVKind:
                    this.uvs = data;
                    break;
                case LIB.VertexBuffer.UV2Kind:
                    this.uvs2 = data;
                    break;
                case LIB.VertexBuffer.UV3Kind:
                    this.uvs3 = data;
                    break;
                case LIB.VertexBuffer.UV4Kind:
                    this.uvs4 = data;
                    break;
                case LIB.VertexBuffer.UV5Kind:
                    this.uvs5 = data;
                    break;
                case LIB.VertexBuffer.UV6Kind:
                    this.uvs6 = data;
                    break;
                case LIB.VertexBuffer.ColorKind:
                    this.colors = data;
                    break;
                case LIB.VertexBuffer.MatricesIndicesKind:
                    this.matricesIndices = data;
                    break;
                case LIB.VertexBuffer.MatricesWeightsKind:
                    this.matricesWeights = data;
                    break;
                case LIB.VertexBuffer.MatricesIndicesExtraKind:
                    this.matricesIndicesExtra = data;
                    break;
                case LIB.VertexBuffer.MatricesWeightsExtraKind:
        ...
        VertexData.prototype._applyTo = function (meshOrGeometry, updatable) {
            ...
            if (this.positions) {
                meshOrGeometry.setVerticesData(LIB.VertexBuffer.PositionKind, this.positions, updatable);
            }
            if (this.normals) {
                meshOrGeometry.setVerticesData(LIB.VertexBuffer.NormalKind, this.normals, updatable);
            }
            if (this.tangents) {
                meshOrGeometry.setVerticesData(LIB.VertexBuffer.TangentKind, this.tangents, updatable);
            }
            if (this.uvs) {
                meshOrGeometry.setVerticesData(LIB.VertexBuffer.UVKind, this.uvs, updatable);
            }
            if (this.uvs2) {
                meshOrGeometry.setVerticesData(LIB.VertexBuffer.UV2Kind, this.uvs2, updatable);
            }
            if (this.uvs3) {
                meshOrGeometry.setVerticesData(LIB.VertexBuffer.UV3Kind, this.uvs3, updatable);
            }
            if (this.uvs4) {
                meshOrGeometry.setVerticesData(LIB.VertexBuffer.UV4Kind, this.uvs4, updatable);
            }
            if (this.uvs5) {
                meshOrGeometry.setVerticesData(LIB.VertexBuffer.UV5Kind, this.uvs5, updatable);
            }
            if (this.uvs6) {
                meshOrGeometry.setVerticesData(LIB.VertexBuffer.UV6Kind, this.uvs6, updatable);
            }
            if (this.colors) {
                meshOrGeometry.setVerticesData(LIB.VertexBuffer.ColorKind, this.colors, updatable);
            }
            if (this.matricesIndices) {
                meshOrGeometry.setVerticesData(LIB.VertexBuffer.MatricesIndicesKind, this.matricesIndices, updatable);
            }
            if (this.matricesWeights) {
                meshOrGeometry.setVerticesData(LIB.VertexBuffer.MatricesWeightsKind, this.matricesWeights, updatable);
            }
            if (this.matricesIndicesExtra) {
                meshOrGeometry.setVerticesData(LIB.VertexBuffer.MatricesIndicesExtraKind, this.matricesIndicesExtra, updatable);
            }
            if (this.matricesWeightsExtra) {
                meshOrGeometry.setVerticesData(LIB.VertexBuffer.MatricesWeightsExtraKind, this.matricesWeightsExtra, updatable);
            }
            if (this.indices) {
        ...
        VertexData.prototype._update = function (meshOrGeometry, updateExtends, makeItUnique) {
            if (this.positions) {
                meshOrGeometry.updateVerticesData(LIB.VertexBuffer.PositionKind, this.positions, updateExtends, makeItUnique);
            }
            if (this.normals) {
                meshOrGeometry.updateVerticesData(LIB.VertexBuffer.NormalKind, this.normals, updateExtends, makeItUnique);
            }
            if (this.tangents) {
                meshOrGeometry.updateVerticesData(LIB.VertexBuffer.TangentKind, this.tangents, updateExtends, makeItUnique);
            }
            if (this.uvs) {
                meshOrGeometry.updateVerticesData(LIB.VertexBuffer.UVKind, this.uvs, updateExtends, makeItUnique);
            }
            if (this.uvs2) {
                meshOrGeometry.updateVerticesData(LIB.VertexBuffer.UV2Kind, this.uvs2, updateExtends, makeItUnique);
            }
            if (this.uvs3) {
                meshOrGeometry.updateVerticesData(LIB.VertexBuffer.UV3Kind, this.uvs3, updateExtends, makeItUnique);
            }
            if (this.uvs4) {
                meshOrGeometry.updateVerticesData(LIB.VertexBuffer.UV4Kind, this.uvs4, updateExtends, makeItUnique);
            }
            if (this.uvs5) {
                meshOrGeometry.updateVerticesData(LIB.VertexBuffer.UV5Kind, this.uvs5, updateExtends, makeItUnique);
            }
            if (this.uvs6) {
                meshOrGeometry.updateVerticesData(LIB.VertexBuffer.UV6Kind, this.uvs6, updateExtends, makeItUnique);
            }
            if (this.colors) {
                meshOrGeometry.updateVerticesData(LIB.VertexBuffer.ColorKind, this.colors, updateExtends, makeItUnique);
            }
            if (this.matricesIndices) {
                meshOrGeometry.updateVerticesData(LIB.VertexBuffer.MatricesIndicesKind, this.matricesIndices, updateExtends, makeItUnique);
            }
            if (this.matricesWeights) {
                meshOrGeometry.updateVerticesData(LIB.VertexBuffer.MatricesWeightsKind, this.matricesWeights, updateExtends, makeItUnique);
            }
            if (this.matricesIndicesExtra) {
                meshOrGeometry.updateVerticesData(LIB.VertexBuffer.MatricesIndicesExtraKind, this.matricesIndicesExtra, updateExtends, makeItUnique);
            }
            if (this.matricesWeightsExtra) {
                meshOrGeometry.updateVerticesData(LIB.VertexBuffer.MatricesWeightsExtraKind, this.matricesWeightsExtra, updateExtends, makeItUnique);
            }
            if (this.indices) {
        ...
        VertexData.prototype.transform = function (matrix) {
            ...
            if (this.positions) {
                ...
                for (index = 0; index < this.positions.length; index += 3) {
                    LIB.Vector3.FromArrayToRef(this.positions, index, position);
                    LIB.Vector3.TransformCoordinatesToRef(position, matrix, transformed);
            ...
            if (this.normals) {
                ...
                for (index = 0; index < this.normals.length; index += 3) {
                    LIB.Vector3.FromArrayToRef(this.normals, index, normal);
                    LIB.Vector3.TransformNormalToRef(normal, matrix, transformed);
            ...
            if (this.tangents) {
                var tangent = LIB.Vector4.Zero();
                var tangentTransformed = LIB.Vector4.Zero();
                for (index = 0; index < this.tangents.length; index += 4) {
                    LIB.Vector4.FromArrayToRef(this.tangents, index, tangent);
                    LIB.Vector4.TransformNormalToRef(tangent, matrix, tangentTransformed);
        ...
        VertexData._ExtractFrom = function (meshOrGeometry, copyWhenShared, forceCopy) {
            ...
            if (meshOrGeometry.isVerticesDataPresent(LIB.VertexBuffer.PositionKind)) {
                result.positions = meshOrGeometry.getVerticesData(LIB.VertexBuffer.PositionKind, copyWhenShared, forceCopy);
            }
            if (meshOrGeometry.isVerticesDataPresent(LIB.VertexBuffer.NormalKind)) {
                result.normals = meshOrGeometry.getVerticesData(LIB.VertexBuffer.NormalKind, copyWhenShared, forceCopy);
            }
            if (meshOrGeometry.isVerticesDataPresent(LIB.VertexBuffer.TangentKind)) {
                result.tangents = meshOrGeometry.getVerticesData(LIB.VertexBuffer.TangentKind, copyWhenShared, forceCopy);
            }
            if (meshOrGeometry.isVerticesDataPresent(LIB.VertexBuffer.UVKind)) {
                result.uvs = meshOrGeometry.getVerticesData(LIB.VertexBuffer.UVKind, copyWhenShared, forceCopy);
            }
            if (meshOrGeometry.isVerticesDataPresent(LIB.VertexBuffer.UV2Kind)) {
                result.uvs2 = meshOrGeometry.getVerticesData(LIB.VertexBuffer.UV2Kind, copyWhenShared, forceCopy);
            }
            if (meshOrGeometry.isVerticesDataPresent(LIB.VertexBuffer.UV3Kind)) {
                result.uvs3 = meshOrGeometry.getVerticesData(LIB.VertexBuffer.UV3Kind, copyWhenShared, forceCopy);
            }
            if (meshOrGeometry.isVerticesDataPresent(LIB.VertexBuffer.UV4Kind)) {
                result.uvs4 = meshOrGeometry.getVerticesData(LIB.VertexBuffer.UV4Kind, copyWhenShared, forceCopy);
            }
            if (meshOrGeometry.isVerticesDataPresent(LIB.VertexBuffer.UV5Kind)) {
                result.uvs5 = meshOrGeometry.getVerticesData(LIB.VertexBuffer.UV5Kind, copyWhenShared, forceCopy);
            }
            if (meshOrGeometry.isVerticesDataPresent(LIB.VertexBuffer.UV6Kind)) {
                result.uvs6 = meshOrGeometry.getVerticesData(LIB.VertexBuffer.UV6Kind, copyWhenShared, forceCopy);
            }
            if (meshOrGeometry.isVerticesDataPresent(LIB.VertexBuffer.ColorKind)) {
                result.colors = meshOrGeometry.getVerticesData(LIB.VertexBuffer.ColorKind, copyWhenShared, forceCopy);
            }
            if (meshOrGeometry.isVerticesDataPresent(LIB.VertexBuffer.MatricesIndicesKind)) {
                result.matricesIndices = meshOrGeometry.getVerticesData(LIB.VertexBuffer.MatricesIndicesKind, copyWhenShared, forceCopy);
            }
            if (meshOrGeometry.isVerticesDataPresent(LIB.VertexBuffer.MatricesWeightsKind)) {
                result.matricesWeights = meshOrGeometry.getVerticesData(LIB.VertexBuffer.MatricesWeightsKind, copyWhenShared, forceCopy);
            }
            if (meshOrGeometry.isVerticesDataPresent(LIB.VertexBuffer.MatricesIndicesExtraKind)) {
                result.matricesIndicesExtra = meshOrGeometry.getVerticesData(LIB.VertexBuffer.MatricesIndicesExtraKind, copyWhenShared, forceCopy);
            }
            if (meshOrGeometry.isVerticesDataPresent(LIB.VertexBuffer.MatricesWeightsExtraKind)) {
                result.matricesWeightsExtra = meshOrGeometry.getVerticesData(LIB.VertexBuffer.MatricesWeightsExtraKind, copyWhenShared, forceCopy);
            }
        ...
        VertexData.CreateRibbon = function (options) {
            ...
            var sideOrientation = (options.sideOrientation === 0) ? 0 : options.sideOrientation || LIB.Mesh.DEFAULTSIDE;
            ...
            if (colors) {
                vertexData.set(colors, LIB.VertexBuffer.ColorKind);
            }
            if (closePath) {
                vertexData._idx = idx;
            }
        ...
        VertexData.CreateBox = function (options) {
            var normalsSource = [
                ...
                new LIB.Vector3(0, 0, -1),
                new LIB.Vector3(1, 0, 0),
                new LIB.Vector3(-1, 0, 0),
                new LIB.Vector3(0, 1, 0),
                new LIB.Vector3(0, -1, 0)
            ];
            var indices = [];
            var positions = [];
            ...
            for (var f = 0; f < 6; f++) {
                if (faceUV[f] === undefined) {
                    faceUV[f] = new LIB.Vector4(0, 0, 1, 1);
                }
                if (faceColors && faceColors[f] === undefined) {
                    faceColors[f] = new LIB.Color4(1, 1, 1, 1);
                }
            }
            var scaleVector = new LIB.Vector3(width / 2, height / 2, depth / 2);
            // Create each face in turn.
            for (var index = 0; index < normalsSource.length; index++) {
                var normal = normalsSource[index];
                // Get two vectors perpendicular to the face normal and to each other.
                var side1 = new LIB.Vector3(normal.y, normal.z, normal.x);
                var side2 = LIB.Vector3.Cross(normal, side1);
            ...
            vertexData.uvs = uvs;
            if (faceColors) {
                var totalColors = (sideOrientation === LIB.Mesh.DOUBLESIDE) ? colors.concat(colors) : colors;
        ...
        VertexData.CreateSphere = function (options) {
            ...
            var sideOrientation = (options.sideOrientation === 0) ? 0 : options.sideOrientation || LIB.Mesh.DEFAULTSIDE;
            var radius = new LIB.Vector3(diameterX / 2, diameterY / 2, diameterZ / 2);
            ...
            for (var zRotationStep = 0; zRotationStep <= totalZRotationSteps; zRotationStep++) {
                ...
                for (var yRotationStep = 0; yRotationStep <= totalYRotationSteps; yRotationStep++) {
                    ...
                    var rotationZ = LIB.Matrix.RotationZ(-angleZ);
                    var rotationY = LIB.Matrix.RotationY(angleY);
                    var afterRotZ = LIB.Vector3.TransformCoordinates(LIB.Vector3.Up(), rotationZ);
                    var complete = LIB.Vector3.TransformCoordinates(afterRotZ, rotationY);
        ...
        VertexData.CreateCylinder = function (options) {
            ...
            var ringVertex = LIB.Vector3.Zero();
            var ringNormal = LIB.Vector3.Zero();
            var ringFirstVertex = LIB.Vector3.Zero();
            var ringFirstNormal = LIB.Vector3.Zero();
            var quadNormal = LIB.Vector3.Zero();
            var Y = LIB.Axis.Y;
            ...
            for (i = 0; i <= subdivisions; i++) {
                ...
                for (r = 0; r < ringIdx; r++) {
                    ...
                    if (arc !== 1 && enclose) {
                        ...
                        LIB.Vector3.CrossToRef(Y, ringNormal, quadNormal);
                        quadNormal.normalize();
                        normals.push(quadNormal.x, quadNormal.y, quadNormal.z, quadNormal.x, quadNormal.y, quadNormal.z);
                        LIB.Vector3.CrossToRef(ringFirstNormal, Y, quadNormal);
                        quadNormal.normalize();
                        normals.push(quadNormal.x, quadNormal.y, quadNormal.z, quadNormal.x, quadNormal.y, quadNormal.z);
                        if (hasRings) {
            ...
            var createCylinderCap = function (isTop) {
                ...
                var center = new LIB.Vector3(0, offset, 0);
                ...
                var textureScale = new LIB.Vector2(0.5, 0.5);
                for (i = 0; i <= tessellation; i++) {
                    angle = Math.PI * 2 * i * arc / tessellation;
                    var cos = Math.cos(-angle);
                    var sin = Math.sin(-angle);
                    circleVector = new LIB.Vector3(cos * radius, offset, sin * radius);
                    var textureCoordinate = new LIB.Vector2(cos * textureScale.x + 0.5, sin * textureScale.y + 0.5);
        ...
        VertexData.CreateTorus = function (options) {
            ...
            for (var i = 0; i <= tessellation; i++) {
                ...
                var transform = LIB.Matrix.Translation(diameter / 2.0, 0, 0).multiply(LIB.Matrix.RotationY(outerAngle));
                for (var j = 0; j <= tessellation; j++) {
                    ...
                    // Create a vertex.
                    var normal = new LIB.Vector3(dx, dy, 0);
                    var position = normal.scale(thickness / 2);
                    var textureCoordinate = new LIB.Vector2(u, v);
                    position = LIB.Vector3.TransformCoordinates(position, transform);
                    normal = LIB.Vector3.TransformNormal(normal, transform);
        ...
        VertexData.CreateGround = function (options) {
            ...
            for (row = 0; row <= subdivisionsY; row++) {
                for (col = 0; col <= subdivisionsX; col++) {
                    var position = new LIB.Vector3((col * width) / subdivisionsX - (width / 2.0), 0, ((subdivisionsY - row) * height) / subdivisionsY - (height / 2.0));
                    var normal = new LIB.Vector3(0, 1.0, 0);
                    positions.push(position.x, position.y, position.z);
                    normals.push(normal.x, normal.y, normal.z);
        ...
        VertexData.CreateGroundFromHeightMap = function (options) {
            ...
            var uvs = [];
            var row, col;
            var filter = options.colorFilter || new LIB.Color3(0.3, 0.59, 0.11);
            // Vertices
            for (row = 0; row <= options.subdivisions; row++) {
                for (col = 0; col <= options.subdivisions; col++) {
                    var position = new LIB.Vector3((col * options.width) / options.subdivisions - (options.width / 2.0), 0, ((options.subdivisions - row) * options.height) / options.subdivisions - (options.height / 2.0));
                    // Compute height
        ...
        VertexData.CreatePolygon = function (polygon, sideOrientation, fUV, fColors, frontUVs, backUVs) {
            ...
            var positions = polygon.getVerticesData(LIB.VertexBuffer.PositionKind);
            var normals = polygon.getVerticesData(LIB.VertexBuffer.NormalKind);
            var uvs = polygon.getVerticesData(LIB.VertexBuffer.UVKind);
        ...
        VertexData.CreateIcoSphere = function (options) {
            ...
            for (v012 = 0; v012 < 3; v012++) {
                face_vertex_pos[v012] = LIB.Vector3.Zero();
                face_vertex_uv[v012] = LIB.Vector2.Zero();
            }
            ...
            for (var face = 0; face < 20; face++) {
                ...
                var interp_vertex = function (i1, i2, c1, c2) {
                    ...
                    //   - face_vertex_pos[0..2]
                    //   - face_vertex_uv[0..2]
                    var pos_x0 = LIB.Vector3.Lerp(face_vertex_pos[0], face_vertex_pos[2], i2 / subdivisions);
                    var pos_x1 = LIB.Vector3.Lerp(face_vertex_pos[1], face_vertex_pos[2], i2 / subdivisions);
                    var pos_interp = (subdivisions === i2) ? face_vertex_pos[2] : LIB.Vector3.Lerp(pos_x0, pos_x1, i1 / (subdivisions - i2));
                    pos_interp.normalize();
                    var vertex_normal;
                    if (flat) {
                        // in flat mode, recalculate normal as face centroid normal
                        var centroid_x0 = LIB.Vector3.Lerp(face_vertex_pos[0], face_vertex_pos[2], c2 / subdivisions);
                        var centroid_x1 = LIB.Vector3.Lerp(face_vertex_pos[1], face_vertex_pos[2], c2 / subdivisions);
                        vertex_normal = LIB.Vector3.Lerp(centroid_x0, centroid_x1, c1 / (subdivisions - c2));
                    }
                    else {
                        // in smooth mode, recalculate normal from each single vertex position
                        vertex_normal = new LIB.Vector3(pos_interp.x, pos_interp.y, pos_interp.z);
                    }
                    ...
                    var uv_x0 = LIB.Vector2.Lerp(face_vertex_uv[0], face_vertex_uv[2], i2 / subdivisions);
                    var uv_x1 = LIB.Vector2.Lerp(face_vertex_uv[1], face_vertex_uv[2], i2 / subdivisions);
                    var uv_interp = (subdivisions === i2) ? face_vertex_uv[2] : LIB.Vector2.Lerp(uv_x0, uv_x1, i1 / (subdivisions - i2));
        ...
        VertexData.CreateTorusKnot = function (options) {
            ...
            var getPos = function (angle) {
                ...
                return new LIB.Vector3(tx, ty, tz);
            };
            // Vertices
            var i;
            var j;
            for (i = 0; i <= radialSegments; i++) {
                ...
                var n = p2.add(p1);
                var bitan = LIB.Vector3.Cross(tang, n);
                n = LIB.Vector3.Cross(bitan, tang);
                bitan.normalize();
                n.normalize();
        ...
        VertexData.ComputeNormals = function (positions, indices, normals, options) {
            ...
            for (index = 0; index < nbFaces; index++) {
                ...
                if (computeDepthSort && options && options.facetPositions) {
                    ...
                    dsf.ind = index * 3;
                    dsf.sqDistance = LIB.Vector3.DistanceSquared(options.facetPositions[index], distanceTo);
                }
        ...
        VertexData._ComputeSides = function (sideOrientation, positions, indices, normals, uvs, frontUVs, backUVs) {
            ...
            var i;
            var n;
            sideOrientation = sideOrientation || LIB.Mesh.DEFAULTSIDE;
            switch (sideOrientation) {
                case LIB.Mesh.FRONTSIDE:
                    // nothing changed
                    break;
                case LIB.Mesh.BACKSIDE:
                    var tmp;
                    // indices
                    for (i = 0; i < li; i += 3) {
                        tmp = indices[i];
                ...
                case LIB.Mesh.DOUBLESIDE:
                    ...
                    frontUVs = frontUVs ? frontUVs : new LIB.Vector4(0.0, 0.0, 1.0, 1.0);
                    backUVs = backUVs ? backUVs : new LIB.Vector4(0.0, 0.0, 1.0, 1.0);
                    u = 0;
                    for (i = 0; i < lu / 2; i++) {
        ...
        VertexData.ImportVertexData = function (parsedVertexData, geometry) {
            ...
            if (positions) {
                vertexData.set(positions, LIB.VertexBuffer.PositionKind);
            }
            // normals
            var normals = parsedVertexData.normals;
            if (normals) {
                vertexData.set(normals, LIB.VertexBuffer.NormalKind);
            }
            // tangents
            var tangents = parsedVertexData.tangents;
            if (tangents) {
                vertexData.set(tangents, LIB.VertexBuffer.TangentKind);
            }
            // uvs
            var uvs = parsedVertexData.uvs;
            if (uvs) {
                vertexData.set(uvs, LIB.VertexBuffer.UVKind);
            }
            // uv2s
            var uv2s = parsedVertexData.uv2s;
            if (uv2s) {
                vertexData.set(uv2s, LIB.VertexBuffer.UV2Kind);
            }
            // uv3s
            var uv3s = parsedVertexData.uv3s;
            if (uv3s) {
                vertexData.set(uv3s, LIB.VertexBuffer.UV3Kind);
            }
            // uv4s
            var uv4s = parsedVertexData.uv4s;
            if (uv4s) {
                vertexData.set(uv4s, LIB.VertexBuffer.UV4Kind);
            }
            // uv5s
            var uv5s = parsedVertexData.uv5s;
            if (uv5s) {
                vertexData.set(uv5s, LIB.VertexBuffer.UV5Kind);
            }
            // uv6s
            var uv6s = parsedVertexData.uv6s;
            if (uv6s) {
                vertexData.set(uv6s, LIB.VertexBuffer.UV6Kind);
            }
            // colors
            var colors = parsedVertexData.colors;
            if (colors) {
                vertexData.set(LIB.Color4.CheckColors4(colors, positions.length / 3), LIB.VertexBuffer.ColorKind);
            }
            // matricesIndices
            var matricesIndices = parsedVertexData.matricesIndices;
            if (matricesIndices) {
                vertexData.set(matricesIndices, LIB.VertexBuffer.MatricesIndicesKind);
            }
            // matricesWeights
            var matricesWeights = parsedVertexData.matricesWeights;
            if (matricesWeights) {
                vertexData.set(matricesWeights, LIB.VertexBuffer.MatricesWeightsKind);
            }
            // indices
