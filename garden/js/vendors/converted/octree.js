(function (LIB) {
    var Octree = /** @class */ (function () {
        function Octree(creationFunc, maxBlockCapacity, maxDepth) {
            ...
            this._selectionContent = new LIB.SmartArrayNoDuplicate(1024);
        ...
        Octree._CreateBlocks = function (worldMin, worldMax, entries, maxBlockCapacity, currentDepth, maxDepth, target, creationFunc) {
            ...
            var blockSize = new LIB.Vector3((worldMax.x - worldMin.x) / 2, (worldMax.y - worldMin.y) / 2, (worldMax.z - worldMin.z) / 2);
            // Segmenting space
            for (var x = 0; x < 2; x++) {
                for (var y = 0; y < 2; y++) {
                    for (var z = 0; z < 2; z++) {
                        ...
                        var block = new LIB.OctreeBlock(localMin, localMax, maxBlockCapacity, currentDepth + 1, maxDepth, creationFunc);
...
//# sourceMappingURL=LIB.octree.js.map
