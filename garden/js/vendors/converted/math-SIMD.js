(function (LIB) {
    ...
    var previousMultiplyToArray = LIB.Matrix.prototype.multiplyToArray;
    var previousInvertToRef = LIB.Matrix.prototype.invertToRef;
    var previousLookAtLHToRef = LIB.Matrix.LookAtLHToRef;
    var previousTransformCoordinatesToRef = LIB.Vector3.TransformCoordinatesToRef;
    var previousTransformCoordinatesFromFloatsToRef = LIB.Vector3.TransformCoordinatesFromFloatsToRef;
    var SIMDHelper = /** @class */ (function () {
        ...
        SIMDHelper.DisableSIMD = function () {
            // Replace functions
            LIB.Matrix.prototype.multiplyToArray = previousMultiplyToArray;
            LIB.Matrix.prototype.invertToRef = previousInvertToRef;
            LIB.Matrix.LookAtLHToRef = previousLookAtLHToRef;
            LIB.Vector3.TransformCoordinatesToRef = previousTransformCoordinatesToRef;
            LIB.Vector3.TransformCoordinatesFromFloatsToRef = previousTransformCoordinatesFromFloatsToRef;
        ...
        SIMDHelper.EnableSIMD = function () {
            ...
            // Replace functions
            LIB.Matrix.prototype.multiplyToArray = SIMDMatrix.prototype.multiplyToArraySIMD;
            LIB.Matrix.prototype.invertToRef = SIMDMatrix.prototype.invertToRefSIMD;
            LIB.Matrix.LookAtLHToRef = SIMDMatrix.LookAtLHToRefSIMD;
            LIB.Vector3.TransformCoordinatesToRef = SIMDVector3.TransformCoordinatesToRefSIMD;
            LIB.Vector3.TransformCoordinatesFromFloatsToRef = SIMDVector3.TransformCoordinatesFromFloatsToRefSIMD;
            SIMDHelper._isEnabled = true;
        };
        SIMDHelper._isEnabled = false;
        return SIMDHelper;
    }());
    LIB.SIMDHelper = SIMDHelper;
})(LIB || (LIB = {}));

//# sourceMappingURL=LIB.math.SIMD.js.map
