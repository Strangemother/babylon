(function (LIB) {
    var FreeCamera = /** @class */ (function (_super) {
        ...
        function FreeCamera(name, position, scene) {
            ...
            _this._oldPosition = LIB.Vector3.Zero();
            _this._diffPosition = LIB.Vector3.Zero();
            ...
            _this._onCollisionPositionChange = function (collisionId, newPosition, collidedMesh) {
                ...
                var updatePosition = function (newPos) {
                    ...
                    if (_this._diffPosition.length() > LIB.Engine.CollisionsEpsilon) {
            ...
            _this.inputs = new LIB.FreeCameraInputsManager(_this);
        ...
        FreeCamera.prototype.detachControl = function (element) {
            ...
            this.cameraDirection = new LIB.Vector3(0, 0, 0);
            this.cameraRotation = new LIB.Vector2(0, 0);
        };
        ...
        FreeCamera.prototype._collideWithWorld = function (displacement) {
            var globalPosition;
            if (this.parent) {
                globalPosition = LIB.Vector3.TransformCoordinates(this.position, this.parent.getWorldMatrix());
            }
            else {
