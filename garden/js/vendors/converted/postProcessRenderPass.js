(function (LIB) {
    var PostProcessRenderPass = /** @class */ (function () {
        function PostProcessRenderPass(scene, name, size, renderList, beforeRender, afterRender) {
            this._refCount = 0;
            this._name = name;
            this._renderTexture = new LIB.RenderTargetTexture(name, size, scene);
    ...
    LIB.PostProcessRenderPass = PostProcessRenderPass;
})(LIB || (LIB = {}));

//# sourceMappingURL=LIB.postProcessRenderPass.js.map
