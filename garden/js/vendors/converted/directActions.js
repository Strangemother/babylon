(function (LIB) {
    ...
    LIB.SwitchBooleanAction = SwitchBooleanAction;
    ...
    LIB.SetStateAction = SetStateAction;
    ...
    LIB.SetValueAction = SetValueAction;
    var IncrementValueAction = /** @class */ (function (_super) {
        ...
        IncrementValueAction.prototype._prepare = function () {
            ...
            if (typeof this._effectiveTarget[this._property] !== "number") {
                LIB.Tools.Warn("Warning: IncrementValueAction can only be used with number values");
            }
        };
    ...
    LIB.IncrementValueAction = IncrementValueAction;
        ...
        PlayAnimationAction.prototype.serialize = function (parent) {
            return _super.prototype._serialize.call(this, {
                ...
                properties: [
                    ...
                    { name: "loop", value: LIB.Action._SerializeValueAsString(this.loop) || false }
                ]
            }, parent);
        };
        return PlayAnimationAction;
    }(LIB.Action));
    LIB.PlayAnimationAction = PlayAnimationAction;
    var StopAnimationAction = /** @class */ (function (_super) {
        ...
        StopAnimationAction.prototype.serialize = function (parent) {
            return _super.prototype._serialize.call(this, {
                ...
                properties: [LIB.Action._GetTargetProperty(this._target)]
            }, parent);
        };
        return StopAnimationAction;
    }(LIB.Action));
    LIB.StopAnimationAction = StopAnimationAction;
    var DoNothingAction = /** @class */ (function (_super) {
        __extends(DoNothingAction, _super);
        function DoNothingAction(triggerOptions, condition) {
            if (triggerOptions === void 0) { triggerOptions = LIB.ActionManager.NothingTrigger; }
    ...
    LIB.DoNothingAction = DoNothingAction;
    ...
    LIB.CombineAction = CombineAction;
    ...
    LIB.ExecuteCodeAction = ExecuteCodeAction;
    var SetParentAction = /** @class */ (function (_super) {
        ...
        SetParentAction.prototype.execute = function () {
            ...
            this._target.position = LIB.Vector3.TransformCoordinates(this._target.position, invertParentWorldMatrix);
        ...
        SetParentAction.prototype.serialize = function (parent) {
            return _super.prototype._serialize.call(this, {
                ...
                properties: [
                    LIB.Action._GetTargetProperty(this._target),
                    LIB.Action._GetTargetProperty(this._parent),
                ]
            }, parent);
        };
        return SetParentAction;
    }(LIB.Action));
    LIB.SetParentAction = SetParentAction;
    ...
    LIB.PlaySoundAction = PlaySoundAction;
