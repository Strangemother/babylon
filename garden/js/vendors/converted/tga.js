    ...
    */
    var TGATools = /** @class */ (function () {
        ...
        TGATools.UploadContent = function (gl, data) {
            ...
            if (data.length < 19) {
                LIB.Tools.Error("Unable to load TGA file - Not enough data to contain header");
                return;
            }
            // Read Header
            var offset = 18;
            ...
            if (header.id_length + offset > data.length) {
                LIB.Tools.Error("Unable to load TGA file - Not enough data");
                return;
            }
    ...
    LIB.TGATools = TGATools;
})(LIB || (LIB = {}));

//# sourceMappingURL=LIB.tga.js.map
//# sourceMappingURL=LIB.tga.js.map
