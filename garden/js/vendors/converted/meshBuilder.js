(function (LIB) {
    var MeshBuilder = /** @class */ (function () {
        ...
        /**
         * Creates a box mesh.
         * tuto : http://doc.LIBjs.com/tutorials/Mesh_CreateXXX_Methods_With_Options_Parameter#box
         * The parameter `size` sets the size (float) of each box side (default 1).
         * You can set some different box dimensions by using the parameters `width`, `height` and `depth` (all by default have the same value than `size`).
         * You can set different colors and different images to each box side by using the parameters `faceColors` (an array of 6 Color3 elements) and `faceUV` (an array of 6 Vector4 elements).
         * Please read this tutorial : http://doc.LIBjs.com/tutorials/CreateBox_Per_Face_Textures_And_Colors
        ...
        MeshBuilder.CreateBox = function (name, options, scene) {
            ...
            var vertexData = LIB.VertexData.CreateBox(options);
            vertexData.applyToMesh(box, options.updatable);
            return box;
        };
        /**
         * Creates a sphere mesh.
         * tuto : http://doc.LIBjs.com/tutorials/Mesh_CreateXXX_Methods_With_Options_Parameter#sphere
         ...
         * tuto : http://doc.LIBjs.com/tutorials/Mesh_CreateXXX_Methods_With_Options_Parameter#disc
         ...
         * tuto : http://doc.LIBjs.com/tutorials/Mesh_CreateXXX_Methods_With_Options_Parameter#icosphere
         ...
         * tuto : http://doc.LIBjs.com/tutorials/Mesh_CreateXXX_Methods_With_Options_Parameter#cylinder-or-cone
         ...
         * tuto : http://doc.LIBjs.com/tutorials/Mesh_CreateXXX_Methods_With_Options_Parameter#torus
         ...
         * tuto : http://doc.LIBjs.com/tutorials/Mesh_CreateXXX_Methods_With_Options_Parameter#torus-knot
         ...
         * tuto : http://doc.LIBjs.com/tutorials/Mesh_CreateXXX_Methods_With_Options_Parameter#linesystem
        ...
        /**
         * Creates a line mesh.
         * tuto : http://doc.LIBjs.com/tutorials/Mesh_CreateXXX_Methods_With_Options_Parameter#lines
         ...
         * tuto : http://doc.LIBjs.com/tutorials/Mesh_CreateXXX_Methods_With_Options_Parameter#dashed-lines
         ...
         * tuto : http://doc.LIBjs.com/tutorials/Mesh_CreateXXX_Methods_With_Options_Parameter#extruded-shapes
         *
         ...
         * tuto :http://doc.LIBjs.com/tutorials/Mesh_CreateXXX_Methods_With_Options_Parameter#custom-extruded-shapes
         *
         ...
         * tuto : http://doc.LIBjs.com/tutorials/Mesh_CreateXXX_Methods_With_Options_Parameter#lathe
         *
         ...
         * tuto : http://doc.LIBjs.com/tutorials/Mesh_CreateXXX_Methods_With_Options_Parameter#plane
         ...
         * tuto : http://doc.LIBjs.com/tutorials/Mesh_CreateXXX_Methods_With_Options_Parameter#tiled-ground
         ...
         * tuto : http://doc.LIBjs.com/tutorials/Mesh_CreateXXX_Methods_With_Options_Parameter#ground-from-a-height-map
        ...
        */
         ...
         *
         * tuto : http://doc.LIBjs.com/tutorials/Mesh_CreateXXX_Methods_With_Options_Parameter#tube
         ...
         *
         * tuto : http://doc.LIBjs.com/tutorials/Mesh_CreateXXX_Methods_With_Options_Parameter#polyhedron
         ...
         * tuto : http://doc.LIBjs.com/tutorials/Mesh_CreateXXX_Methods_With_Options_Parameter#decals
