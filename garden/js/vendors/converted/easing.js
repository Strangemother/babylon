(function (LIB) {
    ...
    LIB.EasingFunction = EasingFunction;
    ...
    LIB.ExponentialEase = ExponentialEase;
    ...
    LIB.QuadraticEase = QuadraticEase;
    ...
    var BezierCurveEase = /** @class */ (function (_super) {
        ...
        BezierCurveEase.prototype.easeInCore = function (gradient) {
            return LIB.BezierCurve.interpolate(gradient, this.x1, this.y1, this.x2, this.y2);
        };
