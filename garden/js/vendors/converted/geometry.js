(function (LIB) {
    var Geometry = /** @class */ (function () {
        ...
        Geometry.prototype.updateExtend = function (data, stride) {
            ...
            if (!data) {
                data = this._vertexBuffers[LIB.VertexBuffer.PositionKind].getData();
            }
            this._extend = LIB.Tools.ExtractMinAndMax(data, 0, this._totalVertices, this.boundingBias, stride);
        };
        ...
        (function (Primitives) {
            ...
            var Box = /** @class */ (function (_super) {
                ...
                Box.prototype._regenerateVertexData = function () {
                    return LIB.VertexData.CreateBox({ size: this.size, sideOrientation: this.side });
                };
    ...
    })(Geometry = LIB.Geometry || (LIB.Geometry = {}));
})(LIB || (LIB = {}));
