...
(function (LIB) {
    ...
    var HDRTools = /** @class */ (function () {
        ...
        HDRTools.GetCubeMapTextureData = function (buffer, size) {
            ...
            var cubeMapData = LIB.PanoramaToCubeMapTools.ConvertPanoramaToCubemap(data, hdrInfo.width, hdrInfo.height, size);
            return cubeMapData;
        };
        /**
    ...
    LIB.HDRTools = HDRTools;
})(LIB || (LIB = {}));

//# sourceMappingURL=LIB.hdr.js.map
//# sourceMappingURL=LIB.hdr.js.map
