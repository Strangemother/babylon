...
(function (LIB) {
    ...
    var ColorCurves = /** @class */ (function () {
        function ColorCurves() {
            this._dirty = true;
            this._tempColor = new LIB.Color4(0, 0, 0, 0);
            this._globalCurve = new LIB.Color4(0, 0, 0, 0);
            this._highlightsCurve = new LIB.Color4(0, 0, 0, 0);
            this._midtonesCurve = new LIB.Color4(0, 0, 0, 0);
            this._shadowsCurve = new LIB.Color4(0, 0, 0, 0);
            this._positiveCurve = new LIB.Color4(0, 0, 0, 0);
            this._negativeCurve = new LIB.Color4(0, 0, 0, 0);
            this._globalHue = 30;
        ...
        ColorCurves.prototype.clone = function () {
            return LIB.SerializationHelper.Clone(function () { return new ColorCurves(); }, this);
        };
        /**
        ...
        ColorCurves.Parse = function (source) {
            return LIB.SerializationHelper.Parse(function () { return new ColorCurves(); }, source, null, null);
        };
        __decorate([
            LIB.serialize()
