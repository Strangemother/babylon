(function (LIB) {
    var LinesMesh = /** @class */ (function (_super) {
        ...
        function LinesMesh(name, scene, parent, source, doNotCloneChildren, useVertexColor, useVertexAlpha) {
            ...
            _this.color = new LIB.Color3(1, 1, 1);
            _this.alpha = 1;
            if (source) {
            ...
            if (!useVertexColor) {
                ...
                options.attributes.push(LIB.VertexBuffer.ColorKind);
            }
            _this._colorShader = new LIB.ShaderMaterial("colorShader", _this.getScene(), "color", options);
            return _this;
        }
        Object.defineProperty(LinesMesh.prototype, "intersectionThreshold", {
            ...
            set: function (value) {
                ...
                if (this.geometry) {
                    this.geometry.boundingBias = new LIB.Vector2(0, value);
                }
            },
            enumerable: true,
            configurable: true
        ...
        LinesMesh.prototype._draw = function (subMesh, fillMode, instancesCount) {
            ...
            // Draw order
            engine.drawElementsType(LIB.Material.LineListDrawMode, subMesh.indexStart, subMesh.indexCount);
            return this;
        };
