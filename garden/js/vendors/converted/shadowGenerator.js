...
(function (LIB) {
     ...
     * Documentation: https://doc.LIBjs.com/LIB101/shadows
     */
    var ShadowGenerator = /** @class */ (function () {
        ...
        function ShadowGenerator(mapSize, light, useFullFloatFirst) {
            ...
            this._cachedPosition = new LIB.Vector3(Number.MAX_VALUE, Number.MAX_VALUE, Number.MAX_VALUE);
            this._cachedDirection = new LIB.Vector3(Number.MAX_VALUE, Number.MAX_VALUE, Number.MAX_VALUE);
        ...
        ShadowGenerator.prototype._initializeShadowMap = function () {
            ...
            if (engine.webGLVersion > 1) {
                this._shadowMap = new LIB.RenderTargetTexture(this._light.name + "_shadowMap", this._mapSize, this._scene, false, true, this._textureType, this._light.needCube(), undefined, false, false);
                this._shadowMap.createDepthStencilTexture(LIB.Engine.LESS, true);
            }
            else {
            ...
            var clearZero = new LIB.Color4(0, 0, 0, 0);
            var clearOne = new LIB.Color4(1.0, 1.0, 1.0, 1.0);
        ...
        ShadowGenerator.prototype._renderSubMeshForShadowMap = function (subMesh) {
            ...
            if (this.isReady(subMesh, hardwareInstancedRendering)) {
                ...
                if (this.getLight().getTypeID() === LIB.Light.LIGHTTYPEID_DIRECTIONALLIGHT) {
                ...
                // Morph targets
                LIB.MaterialHelper.BindMorphTargetParameters(mesh, this._effect);
        ...
        ShadowGenerator.prototype.isReady = function (subMesh, useInstances) {
            ...
            var material = subMesh.getMaterial();
            // Normal bias.
            if (this.normalBias && mesh.isVerticesDataPresent(LIB.VertexBuffer.NormalKind)) {
