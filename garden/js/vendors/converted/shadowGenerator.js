(function (LIB) {
    var ShadowGenerator = /** @class */ (function () {
         ...
         * Documentation : http://doc.LIBjs.com/tutorials/shadows
         */
        function ShadowGenerator(mapSize, light, useFullFloatFirst) {
            ...
            this._lightDirection = LIB.Vector3.Zero();
            this._viewMatrix = LIB.Matrix.Zero();
            this._projectionMatrix = LIB.Matrix.Zero();
            this._transformMatrix = LIB.Matrix.Zero();
            this._currentFaceIndex = 0;
            this._currentFaceIndexCache = 0;
            this._defaultTextureMatrix = LIB.Matrix.Identity();
            ...
            if (!useFullFloatFirst) {
                if (caps.textureHalfFloatRender && caps.textureHalfFloatLinearFiltering) {
                    this._textureType = LIB.Engine.TEXTURETYPE_HALF_FLOAT;
                }
                else if (caps.textureFloatRender && caps.textureFloatLinearFiltering) {
                    this._textureType = LIB.Engine.TEXTURETYPE_FLOAT;
                }
                else {
                    this._textureType = LIB.Engine.TEXTURETYPE_UNSIGNED_INT;
                }
            }
            else {
        ...
        Object.defineProperty(ShadowGenerator.prototype, "useVarianceShadowMap", {
            get: function () {
                LIB.Tools.Warn("VSM are now replaced by ESM. Please use useExponentialShadowMap instead.");
        ...
        Object.defineProperty(ShadowGenerator.prototype, "useBlurVarianceShadowMap", {
            get: function () {
                LIB.Tools.Warn("VSM are now replaced by ESM. Please use useBlurExponentialShadowMap instead.");
        ...
        ShadowGenerator.prototype._initializeShadowMap = function () {
            var _this = this;
            // Render target
            this._shadowMap = new LIB.RenderTargetTexture(this._light.name + "_shadowMap", this._mapSize, this._scene, false, true, this._textureType, this._light.needCube());
            this._shadowMap.wrapU = LIB.Texture.CLAMP_ADDRESSMODE;
            this._shadowMap.wrapV = LIB.Texture.CLAMP_ADDRESSMODE;
            this._shadowMap.anisotropicFilteringLevel = 1;
            this._shadowMap.updateSamplingMode(LIB.Texture.BILINEAR_SAMPLINGMODE);
            ...
            this._shadowMap.onClearObservable.add(function (engine) {
                if (_this.useExponentialShadowMap || _this.useBlurExponentialShadowMap) {
                    engine.clear(new LIB.Color4(0, 0, 0, 0), true, true, true);
                }
                else {
        ...
        ShadowGenerator.prototype._initializeBlurRTTAndPostProcesses = function () {
            ...
            if (!this.useKernelBlur || this.blurScale !== 1.0) {
                this._shadowMap2 = new LIB.RenderTargetTexture(this._light.name + "_shadowMap2", targetSize, this._scene, false, true, this._textureType);
                this._shadowMap2.wrapU = LIB.Texture.CLAMP_ADDRESSMODE;
                this._shadowMap2.wrapV = LIB.Texture.CLAMP_ADDRESSMODE;
                this._shadowMap2.updateSamplingMode(LIB.Texture.BILINEAR_SAMPLINGMODE);
            }
            if (this.useKernelBlur) {
                this._kernelBlurXPostprocess = new LIB.BlurPostProcess(this._light.name + "KernelBlurX", new LIB.Vector2(1, 0), this.blurKernel, 1.0, null, LIB.Texture.BILINEAR_SAMPLINGMODE, engine, false, this._textureType);
                ...
                this._kernelBlurYPostprocess = new LIB.BlurPostProcess(this._light.name + "KernelBlurY", new LIB.Vector2(0, 1), this.blurKernel, 1.0, null, LIB.Texture.BILINEAR_SAMPLINGMODE, engine, false, this._textureType);
                this._kernelBlurXPostprocess.autoClear = false;
                this._kernelBlurYPostprocess.autoClear = false;
                if (this._textureType === LIB.Engine.TEXTURETYPE_UNSIGNED_INT) {
                ...
                this._boxBlurPostprocess = new LIB.PostProcess(this._light.name + "DepthBoxBlur", "depthBoxBlur", ["screenSize", "boxOffset"], [], 1.0, null, LIB.Texture.BILINEAR_SAMPLINGMODE, engine, false, "#define OFFSET " + this._blurBoxOffset, this._textureType);
        ...
        ShadowGenerator.prototype._renderSubMeshForShadowMap = function (subMesh) {
            ...
            if (this.isReady(subMesh, hardwareInstancedRendering)) {
                ...
                // Draw
                mesh._processRendering(subMesh, this._effect, LIB.Material.TriangleFillMode, batch, hardwareInstancedRendering, function (isInstance, world) { return _this._effect.setMatrix("world", world); });
                if (this.forceBackFacesOnly) {
        ...
        ShadowGenerator.prototype._applyFilterValues = function () {
            ...
            if (this.filter === ShadowGenerator.FILTER_NONE) {
                this._shadowMap.updateSamplingMode(LIB.Texture.NEAREST_SAMPLINGMODE);
            }
            else {
                this._shadowMap.updateSamplingMode(LIB.Texture.BILINEAR_SAMPLINGMODE);
            }
        ...
        ShadowGenerator.prototype.getTransformMatrix = function () {
            ...
            LIB.Vector3.NormalizeToRef(this._light.getShadowDirection(this._currentFaceIndex), this._lightDirection);
            if (Math.abs(LIB.Vector3.Dot(this._lightDirection, LIB.Vector3.Up())) === 1.0) {
            ...
            if (this._light.needProjectionMatrixCompute() || !this._cachedPosition || !this._cachedDirection || !lightPosition.equals(this._cachedPosition) || !this._lightDirection.equals(this._cachedDirection)) {
                ...
                LIB.Matrix.LookAtLHToRef(lightPosition, lightPosition.add(this._lightDirection), LIB.Vector3.Up(), this._viewMatrix);
                var shadowMap = this.getShadowMap();
                if (shadowMap) {
                    var renderList = shadowMap.renderList;
                    if (renderList) {
    ...
    LIB.ShadowGenerator = ShadowGenerator;
})(LIB || (LIB = {}));

//# sourceMappingURL=LIB.shadowGenerator.js.map
