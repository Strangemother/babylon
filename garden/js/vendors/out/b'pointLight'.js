    ...
    var PointLight = /** @class */ (function (_super) {
        ...
        PointLight.prototype.getShadowDirection = function (faceIndex) {
            if (this.direction) {
                ...
                switch (faceIndex) {
                    case 0:
                        return new LIB.Vector3(1.0, 0.0, 0.0);
                    case 1:
                        return new LIB.Vector3(-1.0, 0.0, 0.0);
                    case 2:
                        return new LIB.Vector3(0.0, -1.0, 0.0);
                    case 3:
                        return new LIB.Vector3(0.0, 1.0, 0.0);
                    case 4:
                        return new LIB.Vector3(0.0, 0.0, 1.0);
                    case 5:
                        return new LIB.Vector3(0.0, 0.0, -1.0);
                }
            }
        ...
        PointLight.prototype._setDefaultShadowProjectionMatrix = function (matrix, viewMatrix, renderList) {
            ...
            LIB.Matrix.PerspectiveFovLHToRef(this.shadowAngle, 1.0, this.getDepthMinZ(activeCamera), this.getDepthMaxZ(activeCamera), matrix);
        };
