...
(function (LIB) {
    ...
    })(DepthOfFieldEffectBlurLevel = LIB.DepthOfFieldEffectBlurLevel || (LIB.DepthOfFieldEffectBlurLevel = {}));
    ;
    /**
    ...
    var DepthOfFieldEffect = /** @class */ (function (_super) {
        ...
        function DepthOfFieldEffect(scene, depthTexture, blurLevel, pipelineTextureType, blockCompilation) {
            ...
            _this._circleOfConfusion = new LIB.CircleOfConfusionPostProcess("circleOfConfusion", depthTexture, 1, null, LIB.Texture.BILINEAR_SAMPLINGMODE, scene.getEngine(), false, pipelineTextureType, blockCompilation);
            ...
            for (var i = 0; i < blurCount; i++) {
                var blurY = new LIB.DepthOfFieldBlurPostProcess("verticle blur", scene, new LIB.Vector2(0, 1.0), adjustedKernelSize, ratio, null, _this._circleOfConfusion, i == 0 ? _this._circleOfConfusion : null, LIB.Texture.BILINEAR_SAMPLINGMODE, scene.getEngine(), false, pipelineTextureType, blockCompilation);
                blurY.autoClear = false;
                ratio = 0.75 / Math.pow(2, i);
                var blurX = new LIB.DepthOfFieldBlurPostProcess("horizontal blur", scene, new LIB.Vector2(1.0, 0), adjustedKernelSize, ratio, null, _this._circleOfConfusion, null, LIB.Texture.BILINEAR_SAMPLINGMODE, scene.getEngine(), false, pipelineTextureType, blockCompilation);
            ...
            _this._dofMerge = new LIB.DepthOfFieldMergePostProcess("dofMerge", _this._circleOfConfusion, _this._circleOfConfusion, _this._depthOfFieldBlurX, ratio, null, LIB.Texture.BILINEAR_SAMPLINGMODE, scene.getEngine(), false, pipelineTextureType, blockCompilation);
    ...
    LIB.DepthOfFieldEffect = DepthOfFieldEffect;
})(LIB || (LIB = {}));

//# sourceMappingURL=LIB.depthOfFieldEffect.js.map
//# sourceMappingURL=LIB.depthOfFieldEffect.js.map
