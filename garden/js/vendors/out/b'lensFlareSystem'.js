...
(function (LIB) {
    var LensFlareSystem = /** @class */ (function () {
        function LensFlareSystem(name, emitter, scene) {
            ...
            vertices.push(-1, -1);
            vertices.push(1, -1);
            this._vertexBuffers[LIB.VertexBuffer.PositionKind] = new LIB.VertexBuffer(engine, vertices, LIB.VertexBuffer.PositionKind, false, false, 2);
            // Indices
            var indices = [];
            indices.push(0);
            indices.push(1);
            ...
            // Effects
            this._effect = engine.createEffect("lensFlare", [LIB.VertexBuffer.PositionKind], ["color", "viewportMatrix"], ["textureSampler"], "");
        }
        ...
        LensFlareSystem.prototype.computeEffectivePosition = function (globalViewport) {
            ...
            position = LIB.Vector3.Project(position, LIB.Matrix.Identity(), this._scene.getTransformMatrix(), globalViewport);
            this._positionX = position.x;
            this._positionY = position.y;
            position = LIB.Vector3.TransformCoordinates(this.getEmitterPosition(), this._scene.getViewMatrix());
        ...
        LensFlareSystem.prototype._isVisible = function () {
            ...
            direction.normalize();
            var ray = new LIB.Ray(this._scene.activeCamera.globalPosition, direction);
        ...
        LensFlareSystem.prototype.render = function () {
            ...
            for (var index = 0; index < this.lensFlares.length; index++) {
                ...
                var viewportMatrix = LIB.Matrix.FromValues(cw / 2, 0, 0, 0, 0, ch / 2, 0, 0, 0, 0, 1, 0, cx, cy, 0, 1);
        ...
        LensFlareSystem.Parse = function (parsedLensFlareSystem, scene, rootUrl) {
            ...
            for (var index = 0; index < parsedLensFlareSystem.flares.length; index++) {
                ...
                LIB.LensFlare.AddFlare(parsedFlare.size, parsedFlare.position, LIB.Color3.FromArray(parsedFlare.color), parsedFlare.textureName ? rootUrl + parsedFlare.textureName : "", lensFlareSystem);
            }
        ...
        LensFlareSystem.prototype.serialize = function () {
            ...
            for (var index = 0; index < this.lensFlares.length; index++) {
                ...
                serializationObject.flares.push({
                    ...
                    textureName: LIB.Tools.GetFilename(flare.texture ? flare.texture.name : "")
                });
            }
