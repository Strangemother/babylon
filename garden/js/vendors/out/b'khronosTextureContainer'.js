...
(function (LIB) {
    ...
    var KhronosTextureContainer = /** @class */ (function () {
        ...
        function KhronosTextureContainer(arrayBuffer, facesExpected, threeDExpected, textureArrayExpected) {
            ...
            if (identifier[0] !== 0xAB || identifier[1] !== 0x4B || identifier[2] !== 0x54 || identifier[3] !== 0x58 || identifier[4] !== 0x20 || identifier[5] !== 0x31 ||
                ...
                LIB.Tools.Error("texture missing KTX identifier");
                return;
            }
            ...
            if (this.glType !== 0) {
                LIB.Tools.Error("only compressed formats currently supported");
                return;
            }
            else {
            ...
            if (this.pixelHeight === 0 || this.pixelDepth !== 0) {
                LIB.Tools.Error("only 2D textures currently supported");
                return;
            }
            if (this.numberOfArrayElements !== 0) {
                LIB.Tools.Error("texture arrays not currently supported");
                return;
            }
            if (this.numberOfFaces !== facesExpected) {
                LIB.Tools.Error("number of faces expected" + facesExpected + ", but found " + this.numberOfFaces);
                return;
            }
    ...
    LIB.KhronosTextureContainer = KhronosTextureContainer;
})(LIB || (LIB = {}));

//# sourceMappingURL=LIB.khronosTextureContainer.js.map
//# sourceMappingURL=LIB.khronosTextureContainer.js.map
