...
(function (LIB) {
        ...
        function CircleOfConfusionPostProcess(name, depthTexture, options, camera, samplingMode, engine, reusable, textureType, blockCompilation) {
            ...
            _this.onApplyObservable.add(function (effect) {
                if (!_this._depthTexture) {
                    LIB.Tools.Warn("No depth texture set on CircleOfConfusionPostProcess");
                    return;
                }
    ...
    LIB.CircleOfConfusionPostProcess = CircleOfConfusionPostProcess;
})(LIB || (LIB = {}));

//# sourceMappingURL=LIB.circleOfConfusionPostProcess.js.map
//# sourceMappingURL=LIB.circleOfConfusionPostProcess.js.map
