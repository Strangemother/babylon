...
(function (LIB) {
    ...
    LIB.NullEngineOptions = NullEngineOptions;
    /**
     * The null engine class provides support for headless version of LIB.js.
    ...
    var NullEngine = /** @class */ (function (_super) {
        ...
        function NullEngine(options) {
            ...
            _this._caps = new LIB.EngineCapabilities();
            ...
            LIB.Tools.Log("LIB.js null engine (v" + LIB.Engine.Version + ") launched");
            // Wrappers
        ...
        NullEngine.prototype.setAlphaMode = function (mode, noDepthWriteChange) {
            ...
            this._alphaState.alphaBlend = (mode !== LIB.Engine.ALPHA_DISABLE);
            if (!noDepthWriteChange) {
                this.setDepthWrite(mode === LIB.Engine.ALPHA_DISABLE);
            }
        ...
        NullEngine.prototype.createTexture = function (urlArg, noMipmap, invertY, scene, samplingMode, onLoad, onError, buffer, fallBack, format) {
            ...
            var texture = new LIB.InternalTexture(this, LIB.InternalTexture.DATASOURCE_URL);
        ...
        NullEngine.prototype.createRenderTargetTexture = function (size, options) {
            var fullOptions = new LIB.RenderTargetCreationOptions();
            if (options !== undefined && typeof options === "object") {
                fullOptions.generateMipMaps = options.generateMipMaps;
                fullOptions.generateDepthBuffer = options.generateDepthBuffer === undefined ? true : options.generateDepthBuffer;
                fullOptions.generateStencilBuffer = fullOptions.generateDepthBuffer && options.generateStencilBuffer;
                fullOptions.type = options.type === undefined ? LIB.Engine.TEXTURETYPE_UNSIGNED_INT : options.type;
                ...
                fullOptions.type = LIB.Engine.TEXTURETYPE_UNSIGNED_INT;
