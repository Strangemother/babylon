...
(function (LIB) {
    ...
    var VirtualJoystick = /** @class */ (function () {
        ...
        function VirtualJoystick(leftJoystick) {
            ...
            this._touches = new LIB.StringDictionary();
            this.deltaPosition = LIB.Vector3.Zero();
            ...
            this._joystickPointerPos = new LIB.Vector2(0, 0);
            this._joystickPreviousPointerPos = new LIB.Vector2(0, 0);
            // origin joystick position
            this._joystickPointerStartPos = new LIB.Vector2(0, 0);
            this._deltaJoystickVector = new LIB.Vector2(0, 0);
