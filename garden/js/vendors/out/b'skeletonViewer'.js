...
(function (LIB) {
    ...
    (function (Debug) {
        /**
        * Demo available here: http://www.LIBjs-playground.com/#1BZJVJ#8
        */
        var SkeletonViewer = /** @class */ (function () {
            ...
            SkeletonViewer.prototype._getBonePosition = function (position, bone, meshMat, x, y, z) {
                ...
                if (x !== 0 || y !== 0 || z !== 0) {
                    var tmat2 = LIB.Tmp.Matrix[1];
                    LIB.Matrix.IdentityToRef(tmat2);
                    tmat2.m[12] = x;
                    tmat2.m[13] = y;
                    tmat2.m[14] = z;
            ...
            SkeletonViewer.prototype._getLinesForBonesWithLength = function (bones, meshMat) {
                ...
                for (var i = 0; i < len; i++) {
                    ...
                    if (!points) {
                        points = [LIB.Vector3.Zero(), LIB.Vector3.Zero()];
            ...
            SkeletonViewer.prototype.update = function () {
                ...
                if (!this._debugMesh) {
                    this._debugMesh = LIB.MeshBuilder.CreateLineSystem("", { lines: this._debugLines, updatable: true, instance: null }, this._scene);
                    this._debugMesh.renderingGroupId = this.renderingGroupId;
                }
                else {
                    LIB.MeshBuilder.CreateLineSystem("", { lines: this._debugLines, updatable: true, instance: this._debugMesh }, this._scene);
                }
