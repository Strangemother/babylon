    ...
    var SSAORenderingPipeline = /** @class */ (function (_super) {
        ...
        function SSAORenderingPipeline(name, scene, ratio, cameras) {
            ...
            */
            ...
            _this._originalColorPostProcess = new LIB.PassPostProcess("SSAOOriginalSceneColor", combineRatio, null, LIB.Texture.BILINEAR_SAMPLINGMODE, scene.getEngine(), false);
        ...
        SSAORenderingPipeline.prototype._createBlurPostProcess = function (ratio) {
            var _this = this;
            var size = 16;
            this._blurHPostProcess = new LIB.BlurPostProcess("BlurH", new LIB.Vector2(1, 0), size, ratio, null, LIB.Texture.BILINEAR_SAMPLINGMODE, this._scene.getEngine(), false, LIB.Engine.TEXTURETYPE_UNSIGNED_INT);
            this._blurVPostProcess = new LIB.BlurPostProcess("BlurV", new LIB.Vector2(0, 1), size, ratio, null, LIB.Texture.BILINEAR_SAMPLINGMODE, this._scene.getEngine(), false, LIB.Engine.TEXTURETYPE_UNSIGNED_INT);
        ...
        SSAORenderingPipeline.prototype._createSSAOPostProcess = function (ratio) {
            ...
            this._ssaoPostProcess = new LIB.PostProcess("ssao", "ssao", [
                "sampleSphere", "samplesFactor", "randTextureTiles", "totalStrength", "radius",
                "area", "fallOff", "base", "range", "viewport"
            ], ["randomSampler"], ratio, null, LIB.Texture.BILINEAR_SAMPLINGMODE, this._scene.getEngine(), false, "#define SAMPLES " + numSamples + "\n#define SSAO");
