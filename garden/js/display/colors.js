...
modifiers.fog = function(scene) {
    scene.fogMode = LIB.Scene.FOGMODE_EXP2;
    scene.fogDensity = 0.04;
    scene.fogColor = new LIB.Color3(0.8, 0.83, 0.8);
}
...
colors.get = function(value, count=-1, type=colors.DIFFUSE){
    ...
    Assume it was a LIB.Color# type and ensure
...
colors.make = function(r, g, b, a=1, type, count) {
    ...
    result = new LIB[funcName](r,g,b,a);
...
colors.addColors = function(_colors, overwrite=true) {
    ...
    The function calls `colors.make` returning a LIB type.
