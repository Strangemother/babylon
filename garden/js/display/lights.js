...
class Light extends DisplayObject {
    ...
    hookProduceMesh(instance, libFunc, name, config, scene) {
        ...
        the direction to the LIB config, not the entire object. */
        let mesh = new libFunc(name, config.direction, scene)
        return mesh
    }
...
class OldLight extends DisplayObject {
